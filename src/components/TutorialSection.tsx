  ...
  return (
    <div className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative bg-gray-300 rounded-lg overflow-hidden aspect-video flex items-center justify-center hover:bg-gray-400 transition cursor-pointer shadow-lg hover:shadow-xl">
