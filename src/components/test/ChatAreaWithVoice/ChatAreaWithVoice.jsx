    ...
    try {
      ...
      if (!currentChatId) {
        ...
        const response = await axios.post(
          'https://parliament-curves-cancel-foreign.trycloudflare.com/api/chat/create_chat/',
          formData,
          {
            headers: {
        ...
        await axios.post(
          'https://parliament-curves-cancel-foreign.trycloudflare.com/api/chat/add_message_to_chat/',
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
                    ...
                    <img
                      src={
                        user?.profile_picture
                          ? `https://parliament-curves-cancel-foreign.trycloudflare.com/api${user.profile_picture}`
                          : userImage
                      }
                      alt="User"
